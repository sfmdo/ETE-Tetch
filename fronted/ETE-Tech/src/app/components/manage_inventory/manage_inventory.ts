...
@Component({
  ...
  templateUrl: './manage_inventory.html',
  styleUrls: ['./manage_inventory.css']
})
export class ManageInventoryComponent implements OnInit {
  ...
  errorMessage = '';
  successMessage = '';
  categorySelection: string = 'Servicio';
  ...
  ngOnInit(): void {
    this.loadProducts();
    this.form.Category = 'Servicio';
  }

  onCategoryChange(): void {
  if (this.categorySelection !== 'OTRA') {
    this.form.Category = this.categorySelection;
  } else {
    this.form.Category = ''; // Limpiamos para que el usuario escriba
  }
}
  ...
  edit(product: Product): void {
    ...
    if (product.Category === 'Servicio' || product.Category === 'Mantenimiento') {
      this.categorySelection = product.Category;
    } else {
      this.categorySelection = 'OTRA';
    }
  ...
  resetForm(): void {
    this.editingId = null;
    this.categorySelection = 'Servicio';
    this.form.Category = 'Servicio';
